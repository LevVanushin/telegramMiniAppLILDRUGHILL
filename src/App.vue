...
async function submitDiploma() {
  ...
  diplomaDiv.innerHTML = `
    ...
    <div style="position: absolute; bottom: 100px; left: -450px; right: 0;">
      <p style="font-size: 20px; font-weight: 400" font-family: Playfair Display, Cormorant Garamond, Georgia, serif;>${new Date().toLocaleDateString()}</p>
    </div>
  `;
